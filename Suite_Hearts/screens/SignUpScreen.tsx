...
export default function SignUpScreen({ navigation }: Props) {
  ...
  const leaseDurationOptions = Array.from(
    { length: 12 },
    (_, i) => `${i + 1} month${i > 0 ? "s" : ""}`
  );
  ...
  const getTotalSteps = () => {
    if (userType === "homeowner") {
      ...
      const housingCount =
        lookingFor === "housing" || lookingFor === "both" ? 8 : 0; // 8 new housing questions
  ...
  const getQuestions = () => {
    ...
    if (userType === "homeowner") {
      return [
        ...
        {
          key: "yearsExperience",
          label: "How many years of experience do you have renting/hosting?",
          type: "number",
        },
      ...
      const housingQuestions =
        lookingFor === "housing" || lookingFor === "both"
          ? [
              {
                key: "maxRoommates",
                label: "Up to how many people are you okay with living with?",
                type: "number",
              },
              {
                key: "roommateType",
                label: "Roommates or suitemates or both?",
                type: "roommateType",
              },
              {
                key: "preferredCity",
                label: "What city do you want to live in?",
                type: "city",
              },
              {
                key: "preferredLocation",
                label: "Pin exact coordinates on map (Optional)",
                type: "mapPin",
              },
              {
                key: "spaceType",
      ...
      return [
        ...
        {
          key: "university",
          label: "What is your university affiliation? (Optional)",
          type: "university",
        },
        { key: "job", label: "What is your job?", type: "text" },
        {
  ...
  const getFormValue = (key: string) => {
    ...
    if (key === "preferredLocation") {
      return formData.preferredLatitude && formData.preferredLongitude
        ? `${formData.preferredLatitude.toFixed(
            4
          )}, ${formData.preferredLongitude.toFixed(4)}`
        : "";
    }
  ...
  const handleSignUpComplete = async () => {
    const newUser: User = {
      ...
      lookingFor:
        userType === "searcher"
          ? (lookingFor as "roommates" | "housing" | "both")
          : undefined,
      ...
      yearsExperience:
        userType === "homeowner" ? formData.yearsExperience : undefined,
      job: formData.job,
      ...
      maxRoommates:
        userType === "searcher" &&
        (lookingFor === "housing" || lookingFor === "both")
          ? parseInt(formData.maxRoommates)
          : undefined,
      roommateType:
        userType === "searcher" &&
        (lookingFor === "housing" || lookingFor === "both")
          ? (formData.roommateType.toLowerCase() as
              | "roommates"
              | "suitemates"
              | "both")
          : undefined,
      ...
      preferredLatitude:
        userType === "searcher" &&
        (lookingFor === "housing" || lookingFor === "both") &&
        formData.preferredLatitude !== null
          ? formData.preferredLatitude
          : undefined,
      preferredLongitude:
        userType === "searcher" &&
        (lookingFor === "housing" || lookingFor === "both") &&
        formData.preferredLongitude !== null
          ? formData.preferredLongitude
          : undefined,
      spaceType:
        userType === "searcher" &&
        (lookingFor === "housing" || lookingFor === "both")
          ? (formData.spaceType as "Condo" | "Townhome" | "House" | "Dorm")
          : undefined,
      minBudget:
        userType === "searcher" &&
        (lookingFor === "housing" || lookingFor === "both")
          ? parseFloat(formData.minBudget)
          : undefined,
      maxBudget:
        userType === "searcher" &&
        (lookingFor === "housing" || lookingFor === "both")
          ? parseFloat(formData.maxBudget)
          : undefined,
      leaseDuration:
        userType === "searcher" &&
        (lookingFor === "housing" || lookingFor === "both")
      ...
      return (
        <View style={styles.centerContent}>
          <Text style={styles.title}>
            Are you listing a home or looking for a place to stay?
          </Text>
          <View style={styles.buttonRow}>
            <TouchableOpacity
              style={[
                styles.squareButton,
                userType === "homeowner" && styles.squareButtonSelected,
              ]}
              onPress={() => {
            ...
            >
              <Text
                style={[
                  ...
                  userType === "homeowner" && styles.squareButtonTextSelected,
                ]}
              >
                Listing a Home
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.squareButton,
                userType === "searcher" && styles.squareButtonSelected,
              ]}
              onPress={() => {
            ...
            >
              <Text
                style={[
                  styles.squareButtonText,
                  userType === "searcher" && styles.squareButtonTextSelected,
                ]}
              >
                Looking for a Place
              </Text>
        ...
        <View style={styles.centerContent}>
          ...
          <View style={styles.buttonGrid}>
            <TouchableOpacity
              style={[
                styles.squareButton,
                lookingFor === "roommates" && styles.squareButtonSelected,
              ]}
              onPress={() => {
            ...
            >
              <Text
                style={[
                  styles.squareButtonText,
                  lookingFor === "roommates" && styles.squareButtonTextSelected,
                ]}
              >
                Just Roommates
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.squareButton,
                lookingFor === "housing" && styles.squareButtonSelected,
              ]}
              onPress={() => {
            ...
            >
              <Text
                style={[
                  styles.squareButtonText,
                  lookingFor === "housing" && styles.squareButtonTextSelected,
                ]}
              >
                Just Housing
              </Text>
            ...
            <TouchableOpacity
              style={[
                styles.squareButton,
                lookingFor === "both" && styles.squareButtonSelected,
              ]}
              onPress={() => {
                setLookingFor("both");
                setStep(2);
            ...
            >
              <Text
                style={[
                  styles.squareButtonText,
                  lookingFor === "both" && styles.squareButtonTextSelected,
                ]}
              >
                Roommates + Housing
              </Text>
        ...
        {options.map((option) => (
          <TouchableOpacity
            ...
            style={[
              ...
              selectedValue === option && styles.selectionButtonSelected,
            ]}
          ...
          >
            <Text
              style={[
                ...
                selectedValue === option && styles.selectionButtonTextSelected,
              ]}
            >
              {option}
            </Text>
      ...
      >
        <Text
          style={[
            ...
            !selectedValue && styles.dropdownButtonTextPlaceholder,
          ]}
        >
  ...
  const renderQuestionScreen = () => {
    ...
    if (!currentQuestion || (userType === "searcher" && !lookingFor))
      return null;

    const value = getFormValue(currentQuestion.key);
    const wordCount =
      currentQuestion.key === "bio" ? getWordCount(formData.bio) : 0;
    const bioValid =
      currentQuestion.key === "bio" ? wordCount >= 10 && wordCount <= 50 : true;
    ...
    return (
      <View style={styles.centerContent}>
        ...
        {currentQuestion.type === "image" ? (
          ...
          renderDropdown(ageOptions, value, (selected) =>
            updateFormData(currentQuestion.key, selected)
          )
        ) : currentQuestion.type === "race" ? (
          renderDropdown(raceOptions, value, (selected) =>
            updateFormData(currentQuestion.key, selected)
          )
        ) : currentQuestion.type === "university" ? (
          renderDropdown(universityOptions, value, (selected) =>
            updateFormData(currentQuestion.key, selected)
          )
        ) : currentQuestion.type === "roommateType" ? (
          renderDropdown(roommateTypeOptions, value, (selected) =>
            updateFormData(currentQuestion.key, selected)
          )
        ) : currentQuestion.type === "city" ? (
          renderDropdown(cityOptions, value, (selected) =>
            updateFormData(currentQuestion.key, selected)
          )
        ) : currentQuestion.type === "spaceType" ? (
          renderDropdown(spaceTypeOptions, value, (selected) =>
            updateFormData(currentQuestion.key, selected)
          )
        ) : currentQuestion.type === "leaseDuration" ? (
          renderDropdown(leaseDurationOptions, value, (selected) =>
            updateFormData(currentQuestion.key, selected)
          )
        ) : currentQuestion.type === "mapPin" ? (
          <View style={styles.mapPinContainer}>
            <Text style={styles.mapPinText}>
              Map pinning will be implemented
            </Text>
            <TouchableOpacity
          ...
          <View style={styles.bioContainer}>
            ...
            />
            <Text
              style={[styles.wordCount, !bioValid && styles.wordCountError]}
            >
        ...
        <View style={styles.navigationButtons}>
          ...
          <TouchableOpacity
            ...
            disabled={
              !bioValid ||
              (currentQuestion.type === "image" && !formData.profilePicture)
            }
          >
            <Text
              style={[
  ...
  return (
    <View style={styles.container}>
      ...
      >
        {step === 0 || (step === 1 && userType === "searcher" && !lookingFor)
